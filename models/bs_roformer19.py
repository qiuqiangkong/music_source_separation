...
class BSRoformer19a(Fourier):
    def __init__(
        ...
        gamma = 4
        self.encoder1 = TransformerLayers(dim=96, head_dim=96//n_heads, n_heads=n_heads, depth=2)
        self.encoder2 = TransformerLayers(dim=192, head_dim=192//n_heads, n_heads=n_heads, depth=2)
        self.encoder3 = TransformerLayers(dim=384, head_dim=384//n_heads, n_heads=n_heads, depth=2)
        self.encoder4 = TransformerLayers(dim=768, head_dim=768//n_heads, n_heads=n_heads, depth=2)
        ...
        #
        self.decoder1 = TransformerLayers(dim=768, head_dim=768//n_heads, n_heads=n_heads, depth=2)
        self.decoder2 = TransformerLayers(dim=384, head_dim=384//n_heads, n_heads=n_heads, depth=2)
        self.decoder3 = TransformerLayers(dim=192, head_dim=192//n_heads, n_heads=n_heads, depth=2)
        self.decoder4 = TransformerLayers(dim=96, head_dim=96//n_heads, n_heads=n_heads, depth=2)
