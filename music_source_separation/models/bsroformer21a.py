...
class Patch(nn.Module):
    def __init__(self, in_channels: int, out_channels: int):
        ...
        self.decoder1 = DecoderBlock(in_channels * 4, in_channels * 2)
        self.decoder2 = DecoderBlock(in_channels * 2, in_channels)

        self.fc_in = nn.Linear(in_features=in_channels * 4, out_features=out_channels)
        self.fc_out = nn.Linear(in_features=out_channels, out_features=in_channels * 4)
