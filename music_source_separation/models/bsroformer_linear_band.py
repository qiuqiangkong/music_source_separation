...
from music_source_separation.models.bandsplitlinear import BandSplitLinear
...
class BSRoformerLinearBand(Fourier):
    def __init__(self, config: BSRoformerConfig) -> None:

        super(BSRoformerLinearBand, self).__init__(
            n_fft=config.n_fft, 
        ...
        # Band split
        self.bandsplit = BandSplitLinear(
            sr=config.sr, 
            n_fft=config.n_fft, 
