...
from music_source_separation.models.bandsplit_mellinear import BandSplitMelLinear
...
class BSRoformerMelLinear(Fourier):
    def __init__(self, config: BSRoformerConfig) -> None:

        super(BSRoformerMelLinear, self).__init__(
            n_fft=config.n_fft, 
        ...
        # Band split
        self.bandsplit = BandSplitMelLinear(
            sr=config.sr, 
            n_fft=config.n_fft, 
