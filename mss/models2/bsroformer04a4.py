...
from mss.models2.bandsplit2 import BandSplit
from mss.models.fourier import Fourier
from mss.models.rope import RoPE


class BSRoformerMagPhase5(Fourier):
    def __init__(
        self,
        audio_channels=2,
        sample_rate=48000,
        ...
        **kwargs
        ...
        self.bandsplit = BandSplit(
            ...
            out_channels2=audio_channels * 2
        )
    ...
    def forward(self, audio: Tensor) -> Tensor:
        ...
        x = rearrange(x[:, 0 : 4, :, :], 'b (c k) t f -> b c t f k', k=2).contiguous()
