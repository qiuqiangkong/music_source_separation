...
from mss.models2.attention65c import Block, APEBlock
...
class BSRoformer65c(Fourier):
    def __init__(
        ...
        **kwargs
        ...
        # Transformer blocks
        self.t_blocks = nn.ModuleList(APEBlock(dim, n_heads) for _ in range(n_layers))
