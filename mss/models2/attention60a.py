...
from mss.models2.rope60 import RoPE
import time
...
class SelfAttention(nn.Module):
    ...
    def forward(
        ...
        if True: 
            ...
            q = torch.utils.checkpoint.checkpoint(rope, q, use_reentrant=False)
            k = torch.utils.checkpoint.checkpoint(rope, k, use_reentrant=False)
