...
from mss.models2.dsp.banks import mel_linear_banks2
...
class BSRoformer83b(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        # Subband filter
        banks = mel_linear_banks2(sr=sample_rate, n_bands=64, max_bandwidth=max_bandwidth)
