...
class BandSplit(nn.Module):
    def __init__(
        ...
        # )
        self.pre_bandnet = nn.Linear(max_band_width * self.in_channels, self.out_channels)
        self.post_bandnet = nn.Linear(self.out_channels, max_band_width * self.in_channels)
