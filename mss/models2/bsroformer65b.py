...
class BSRoformer65b(Fourier):
    def __init__(
        ...
        **kwargs
        ...
        self.lpes = nn.ModuleList([LearnablePositionalEncoding(64, dim) for _ in range(n_layers)])
    ...
    def forward(self, audio: Tensor) -> Tensor:
        ...
        for t_block, f_block, lpe in zip(self.t_blocks, self.f_blocks, self.lpes):
...
class LearnablePositionalEncoding(torch.nn.Module):
    ...
    def forward(self):
        ...
        """
        return self.pos_embedding(self.positions)
