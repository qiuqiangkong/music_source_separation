...
class Block(nn.Module):
    ...
    def __init__(self, dim: int, num_heads: int) -> None:
        ...
        self.conv1 = nn.Conv2d(dim, dim, kernel_size=(3, 3), padding=(1, 1), bias=False)
        self.conv2 = nn.Conv2d(dim, dim, kernel_size=(3, 3), padding=(1, 1), bias=False)
    ...
    def forward(
        ...
        x = x + self.conv1(F.silu(self.norm_x(x, self.norm3)))
        x = x + self.conv2(F.silu(self.norm_x(x, self.norm4)))
