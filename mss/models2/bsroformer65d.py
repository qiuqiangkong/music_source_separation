...
from mss.models2.attention65d import Block, APEBlock
...
class BSRoformer65d(Fourier):
    def __init__(
        ...
        **kwargs
        ...
        # Transformer blocks
        self.t_blocks = nn.ModuleList(APEBlock(dim, n_heads, 64) for _ in range(n_layers))
