...
from mss.models.bandsplit import BandLinear
...
class BSRoformer15b(Fourier):
    def __init__(
        ...
        **kwargs
        ...
        self.pre_band = BandLinear(self.n_bands, in_channels, dim)
        self.post_band = BandLinear(self.n_bands, dim, in_channels)
