...
class BSRoformer52a(Fourier):
    def __init__(
        ...
        **kwargs
        ...
        # Transformer blocks
        self.blocks_pre = nn.ModuleList(Block(dim_pre, n_heads_pre) for _ in range(1))
        self.blocks_post = nn.ModuleList(Block(dim_pre, n_heads_pre) for _ in range(1))
    ...
    def forward(self, audio: Tensor) -> Tensor:
        ...
        x = rearrange(x, '(b t1 f1) (t2 f2) d -> b d (t1 t2) (f1 f2)', b=B, t1=T1, t2=T2, f2=F2)
